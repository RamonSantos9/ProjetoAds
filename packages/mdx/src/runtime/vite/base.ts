...
export interface BaseCreate<Config> {
  ...
  docs: <Name extends keyof Config>(
    ...
    doc: DocMap<any>;
    meta: MetaMap<any>;
    toXispeDocsSource: () => Source<any>;
    createClientLoader: (options?: any) => any;
  };
}

import { createMDXSourceInternal, type Source } from '@/runtime/shared';
  ...
  return {
    ...
    docs(_, docs, meta) {
      return {
        ...
        meta,
        toXispeDocsSource() {
          return createMDXSourceInternal(
            Object.values(docs).filter((v) => typeof v === 'object') as any,
            Object.values(meta).filter((v) => typeof v === 'object') as any,
          );
        },
      } as any;
    },
