...
export interface XispeDocsDataMap {
  /**
   * [XispeDocs MDX] raw frontmatter, you can modify it
   */
  frontmatter?: Record<string, unknown>;

  /**
   * [XispeDocs MDX] additional ESM exports to write
   */
  ...
  /**
   * [XispeDocs MDX] The compiler object from loader
   */
  _compiler?: CompilerOptions;
  ...
  /**
   * [XispeDocs MDX] Processed Markdown content before `remark-rehype`.
   */
  _markdown?: string;
}
...
declare module 'vfile' {
  ...
  interface DataMap extends XispeDocsDataMap {}
}
