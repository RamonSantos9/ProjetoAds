...
export interface PluginOptions {
  ...
  /**
   * Update Vite config to fix module resolution of XispeDocs
   *
   * @defaultValue true
   */
  ...
  return {
    ...
    config(config) {
      ...
      return mergeConfig(config, {
        optimizeDeps: {
          exclude: XispeDocsDeps,
        },
        resolve: {
          noExternal: XispeDocsDeps,
          dedupe: XispeDocsDeps,
        },
    ...
    async buildStart() {
      ...
      console.log('[XispeDocs MDX] Generating index files');
