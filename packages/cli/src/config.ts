...
function createConfigSchema(isSrc: boolean) {
  ...
  return z.object({
    ...
    commands: z
      .object({
        /**
         * comando para formatar automaticamente o código de saída
         */
...
/**
 * Escrever nova configuração, pular se uma configuração já existe
 *
 * @returns a configuração criada, `undefined` se não foi criada
 */
