...
declare module '@xispedocs/core/source' {
  export interface PageData {
    /**
     * Added by XispeDocs OpenAPI
     */
    _openapi?: {
      method?: string;
    };
...
/**
 * XispeDocs Source API integration, pass this to `plugins` array in `loader()`.
 */
export function openapiPlugin(): LoaderPlugin {
  return {
    name: 'xispedocs:openapi',
    enforce: 'pre',
    transformPageTree: {
      file(node, filePath) {
...
/**
 * Generate virtual pages for XispeDocs Source API
 */
