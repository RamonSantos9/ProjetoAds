...
import type { Registry } from '@xispedocs/cli/build';
import * as path from 'node:path';

const srcDir = path.join(path.dirname(fileURLToPath(import.meta.url)), '../');
const mapToPackage = {
  'contexts/sidebar.tsx': '@xispedocs/ui/contexts/sidebar',
  'contexts/search.tsx': '@xispedocs/ui/contexts/search',
  'contexts/tree.tsx': '@xispedocs/ui/contexts/tree',
  'contexts/i18n.tsx': '@xispedocs/ui/contexts/i18n',
  'contexts/layout.tsx': '@xispedocs/ui/contexts/layout',
  'provider/index.tsx': '@xispedocs/ui/provider',
  'utils/get-sidebar-tabs.tsx': '@xispedocs/ui/utils/get-sidebar-tabs',
  'utils/use-copy-button.ts': '@xispedocs/ui/utils/use-copy-button',
};
