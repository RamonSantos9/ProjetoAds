...
import {
  ...
  type TOCItemType,
  useActiveAnchors,
} from '@xispedocs/core/toc';
import { cn } from '../../utils/cn';
import { useTreeContext } from '@xispedocs/ui/contexts/tree';
import { Link, usePathname } from '@xispedocs/core/framework';
    ...
    <AnchorProvider toc={toc}>
      ...
      {toc.length > 0 && (
        <div className="sticky top-(--fd-nav-height) w-[286px] shrink-0 h-[calc(100dvh-var(--fd-nav-height))] p-4 overflow-auto max-xl:hidden">
          <p className="text-sm text-fd-muted-foreground mb-2">Nesta página</p>
