...
export default function EpisodeDetailClient() {
  ...
  // Configure top header breadcrumbs
  useSetBreadcrumbs([
    { label: 'Episódios', href: '/admin/episodios' },
    { label: episode?.title || 'Carregando...', active: true }
  ]);
  ...
  return (
    <div className="rebrand-body flex min-h-[calc(100vh-64px)] flex-col bg-background px-4 sm:px-8 py-8 text-foreground">
      <main className="relative flex-[1_1_0] mx-auto w-full max-w-6xl pb-8 flex flex-col min-h-0">
        {/* Header containing only the ThemeToggle now, as breadcrumbs moved to top global header */}
              ...
              <div className="flex flex-col gap-6 col-span-1 md:col-span-2 bg-background">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex text-sm text-[#6b7280] bg-[#F6F8FA] dark:bg-[#1F2122] border px-3 py-2 rounded-lg cursor-not-allowed">
                    ...
                    {episode.guests?.map((g: any, i: number) => {
              ...
              <div className="flex flex-col gap-6 col-span-1">
                ...
                <div className="flex flex-col gap-4 bg-background">
                  ...
                  {episode.audioUrl || (episode.tracks && episode.tracks.length > 0) ? (
                    <div className="flex flex-col gap-3 p-4 bg-[#F6F8FA] dark:bg-[#1F2122] border rounded-xl">
