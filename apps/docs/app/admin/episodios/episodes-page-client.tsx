...
export default function EpisodesDashboardPage() {
  ...
  const filtered = episodes.filter(
    (p) => {
      ...
      if (selectedStatus) {
        ...
        if (sStatus === 'outros') {
          matchesStatus = pStatus !== 'publicado' && pStatus !== 'produção';
        } else {
          matchesStatus = pStatus === sStatus;
        }
      }
  ...
  return (
    <div className="rebrand-body flex min-h-[calc(100vh-64px)] bg-[#FFFFFF] dark:bg-fd-background px-4 sm:px-8 py-8 text-fd-foreground">
      <main className="relative mx-auto w-full max-w-6xl pb-8 flex flex-col">
        <div className="flex gap-4 mb-4 md:mb-8 justify-end max-w-full shrink-0 items-center">
        ...
        <div className="w-full p-0 flex flex-col">
          <section className="flex flex-col">
            ...
            <div className="flex flex-col gap-4">
                ...
                <Popover.Root>
                  ...
                  <Popover.Portal>
                    <Popover.Content 
                      ...
                      align="start"
                    >
                      {['Publicado', 'Produção', 'Outros'].map((status) => (
                        <div
                          key={status}
              ...
              {/* List Wrapper - Removed height control to allow natural page scroll */}
