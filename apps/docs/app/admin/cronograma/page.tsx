          ...
          <section className="flex flex-col gap-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <p className="text-[#74748D] dark:text-fd-muted-foreground text-sm max-w-2xl">
                Visualize e organize as datas de gravação, reuniões de pauta e
                lançamentos. Mantenha a cadência do seu podcast em dia.
              </p>
              <ActionButtonRefined
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-1">
                  <button className="p-1.5 hover:bg-fd-accent rounded-lg border border-fd-border transition-colors">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex bg-fd-accent/30 p-1 rounded-lg border border-fd-border">
                  <button className="px-3 py-1 text-[10px] font-bold bg-white dark:bg-[#1A1A1A] rounded-md shadow-sm">
                    Mês
                  </button>
                  <button className="px-3 py-1 text-[10px] font-bold text-fd-muted-foreground">
                    Semana
                  </button>
                </div>
              </div>
            ...
            <div className="grid grid-cols-7 gap-px bg-fd-border border border-fd-border rounded-2xl overflow-hidden mt-2">
              {['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'].map((d) => (
                <div
                  key={d}
                  className="bg-fd-accent/50 p-3 text-center text-[10px] font-bold uppercase tracking-widest text-fd-muted-foreground border-b border-fd-border"
                >
                  {d}
                </div>
              ))}
                    ...
                    <div className="flex justify-between items-start mb-1">
                      ...
                      {dayEvents.length > 0 && isCurrentMonth && (
                        <button className="p-1 opacity-0 group-hover:opacity-100">
                          <MoreHorizontal className="size-3 text-fd-muted-foreground" />
                        </button>
                      )}
                    </div>
