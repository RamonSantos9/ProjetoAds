...
export function ProjectPopover({ isOpen, onClose, onOpenShortcuts, triggerRect }: ProjectPopoverProps) {
  ...
  return (
    <div 
      ...
      style={{ 
        ...
        outline: 'none',
        pointerEvents: 'auto',
        boxShadow: '0 0px 0px 1px rgba(0, 0, 0, 0.06), 0 1px 1px -0.5px rgba(0, 0, 0, 0.06), 0 3px 3px 0 rgba(0, 0, 0, 0.06), 0 6px 6px 0 rgba(0, 0, 0, 0.06), 0 12px 12px 0 rgba(0, 0, 0, 0.04), 0 24px 24px 0px rgba(0, 0, 0, 0.04)'
      }}
    >
      <div className="flex flex-col w-full">
        ...
        <div role="separator" aria-orientation="horizontal" className="h-px bg-black/10 dark:bg-white/10 -mx-0.5 my-0.5"></div>
        ...
        >
          Tema
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-right ml-auto shrink-0 text-gray-alpha-500 w-3.5 h-3.5 -mr-0.5">
