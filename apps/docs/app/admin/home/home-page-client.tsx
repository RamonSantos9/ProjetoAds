        ...
        <div className="hstack justify-center">
          <div className="w-full">
            <div>
              ...
              <div className="flex gap-4 mb-4 md:mb-8 justify-end max-w-full items-center">
              ...
              {isAdmin && (
                <div className="grid grid-cols-2 2xs:grid-cols-3 gap-y-6 gap-x-3 md:gap-3 md:grid-cols-6 mb-8 md:mb-12">
                  {/* New episode */}
                  <a
                    data-agent-id="link-_r_8f_"
                    aria-label="Novo episódio"
                    className="group stack items-center outline-none"
                    data-testid="home-card-text-to-speech"
                    href={`${basePath}/episodios`}
                  >
                    <div className="stack gap-2 w-full max-w-[180px]">
                      <div className="relative overflow-hidden flex-1 rounded-[20px] flex items-center justify-center bg-black/5 dark:bg-white/5 group-hover:bg-black/10 dark:group-hover:bg-white/10 transition-colors duration-200 w-full outline-none group-focus-visible:outline-none group-focus-visible:ring-[1.5px] group-focus-visible:ring-ring">
                        ...
                        <div className="absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center [&_svg]:max-w-[90%]">
                          <svg
                            ...
                            className="dark:hue-rotate-180 dark:invert dark:mix-blend-plus-lighter"
                          >
                            <g className="md:group-hover:scale-110 md:group-hover:rotate-3 origin-center transition-all duration-200 ease-in-out">
                              <rect
                                ...
                                height="42"
                                rx="9"
                                fill="url(#paint0_linear_106_573)"
                              ></rect>
                              <rect
                                x="34"
                                y="35"
                            ...
                            <g className="md:group-hover:scale-125 md:group-hover:-rotate-12 origin-[30px_70px] transition-all duration-200 ease-in-out">
                              <rect
                                ...
                                stroke="#F3F4F6"
                                strokeWidth="2.5"
                                className="md:group-hover:stroke-[#E5E7EB] transition-all duration-200 ease-in-out"
                              ></rect>
                              <path
                      ...
                      <div className="text-center">
                        <p className="font-medium text-xs xs:text-sm text-gray-950 dark:text-gray-100">
                          Novo episódio
                        </p>
                      </div>
                    </div>
                  ...
                  {/* Edit episode */}
                  <a
                    data-agent-id="link-_r_8g_"
                    aria-label="Editar episódio"
                    className="group stack items-center outline-none"
                    data-testid="home-card-audiobook"
                    href={`${basePath}/episodios`}
                  >
                    <div className="stack gap-2 w-full max-w-[180px]">
                      <div className="relative overflow-hidden flex-1 rounded-[20px] flex items-center justify-center bg-black/5 dark:bg-white/5 group-hover:bg-black/10 dark:group-hover:bg-white/10 transition-colors duration-200 w-full outline-none group-focus-visible:outline-none group-focus-visible:ring-[1.5px] group-focus-visible:ring-ring">
                          ...
                          >
                            <g className="md:group-hover:scale-110 origin-center transition-all duration-200 ease-in-out">
                              <rect
                                ...
                                height="42"
                                rx="9"
                                fill="url(#paint0_linear_106_572)"
                              ></rect>
                              <rect
                                x="39"
                                y="53"
                              ...
                              <circle
                                ...
                                cy="3"
                                r="3"
                                transform="matrix(-1 0 0 1 36.1089 26)"
                                fill="#EB524B"
                              ></circle>
                              <rect
                                x="39"
                              ...
                              ></rect>
                              <path
                                d="M24 38.661V27C24 22.5817 27.5817 19 32 19H74C78.4183 19 82 22.5817 82 27V38"
                                stroke="#E5E7EB"
                                strokeWidth="1.5"
                                strokeLinecap="round"
                              ></path>
                  ...
                  {/* Publish episode */}
                  <a
                    data-agent-id="link-_r_8h_"
                    aria-label="Publicar episódio"
                    className="group stack items-center outline-none"
                    data-testid="home-card-image-video"
                    href={`${basePath}/publicacao`}
                  >
                    <div className="stack gap-2 w-full max-w-[180px]">
                      <div className="relative overflow-hidden flex-1 rounded-[20px] flex items-center justify-center bg-black/5 dark:bg-white/5 group-hover:bg-black/10 dark:group-hover:bg-white/10 transition-colors duration-200 w-full outline-none group-focus-visible:outline-none group-focus-visible:ring-[1.5px] group-focus-visible:ring-ring">
                        <div className="relative w-full pb-[100%]"></div>
                        <div className="absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center [&_svg]:max-w-[90%]">
                          ...
                          >
                            <g className="md:group-hover:scale-110 origin-center transition-all duration-200 ease-in-out">
                              ...
                              ></path>
                              <path
                                d="M56 37H34C32.8954 37 32 37.8954 32 39C32 40.1046 32.8954 41 34 41H56C57.1046 41 58 40.1046 58 39C58 37.8954 57.1046 37 56 37Z"
                                fill="#CAEADC"
                              ></path>
                              <path
                                d="M50 44H34C32.8954 44 32 44.8954 32 46C32 47.1046 32.8954 48 34 48H50C51.1046 48 52 47.1046 52 46C52 44.8954 51.1046 44 50 44Z"
                                fill="#CAEADC"
                              ></path>
                              <path
                            ...
                            <g className="md:group-hover:scale-125 md:group-hover:rotate-12 origin-[60px_60px] transition-all duration-200 ease-in-out">
                              ...
                              ></path>
                              <path
                                d="M74.925 62.375v-5.75L81.25 59.5l-6.325 2.875z"
                                fill="#fff"
                                stroke="#fff"
                                strokeWidth="1.25"
                                strokeLinejoin="round"
                  ...
                  {/* Guests */}
                  <a
                    data-agent-id="link-_r_8i_"
                    aria-label="Convidados"
                    className="group stack items-center outline-none"
                    data-testid="home-card-ai-agent"
                    href={`${basePath}/convidados`}
                  >
                    <div className="stack gap-2 w-full max-w-[180px]">
                      <div className="relative overflow-hidden flex-1 rounded-[20px] flex items-center justify-center bg-black/5 dark:bg-white/5 group-hover:bg-black/10 dark:group-hover:bg-white/10 transition-colors duration-200 w-full outline-none group-focus-visible:outline-none group-focus-visible:ring-[1.5px] group-focus-visible:ring-ring">
                        <div className="relative w-full pb-[100%]"></div>
                        <div className="absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center [&_svg]:max-w-[90%]">
                          ...
                          >
                            ...
                            <defs>
                              ...
                              >
                                <image
                                  xlinkHref="/images/home/conversational-ai.png"
                                  width="240"
                                  height="382"
                  ...
                  {/* Music */}
                  <a
                    data-agent-id="link-_r_8j_"
                    aria-label="Música"
                    className="group stack items-center outline-none"
                    data-testid="home-card-music"
                    href={`${basePath}/vinhetas-trilhas`}
                  >
                    <div className="stack gap-2 w-full max-w-[180px]">
                      <div className="relative overflow-hidden flex-1 rounded-[20px] flex items-center justify-center bg-black/5 dark:bg-white/5 group-hover:bg-black/10 dark:group-hover:bg-white/10 transition-colors duration-200 w-full outline-none group-focus-visible:outline-none group-focus-visible:ring-[1.5px] group-focus-visible:ring-ring">
                        <div className="relative w-full pb-[100%]"></div>
                          ...
                          >
                            <g clipPath="url(#clip0_218_14)">
                              ...
                              <g mask="url(#mask0_218_14)">
                                <g className="md:group-hover:scale-110 origin-center transition-all duration-200 ease-in-out">
                                  <path
                                    d="M62.999 40.0615C68.4352 40.0615 72.9385 44.2278 72.9385 49.4824V59.5176C72.9385 64.7722 68.4352 68.9385 62.999 68.9385H4.00098C-1.43517 68.9385 -5.93848 64.7722 -5.93848 59.5176V49.4824C-5.93848 44.2278 -1.43517 40.0615 4.00098 40.0615H62.999Z"
                                    stroke="url(#paint0_linear_218_14)"
                                    strokeWidth="1.87738"
                                  ></path>
                                  <path
                                    d="M62.9992 41H4.00078C-0.970214 41 -5 44.7976 -5 49.4821V59.5179C-5 64.2024 -0.970214 68 4.00078 68H62.9992C67.9702 68 72 64.2024 72 59.5179V49.4821C72 44.7976 67.9702 41 62.9992 41Z"
                                    fill="url(#paint1_linear_218_14)"
                                  ></path>
                                  <path
                                    d="M15.8223 60.1468V49.333"
                                    stroke="#F58633"
                                    strokeOpacity="0.4"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ...
                                  ></path>
                                  <path
                                    d="M32.6143 55.5473V53.9321"
                                    stroke="#F58633"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ></path>
                                  <path
                                    d="M38.2139 55.6655V53.813"
                                    stroke="#F58633"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ></path>
                                  <path
                                    d="M43.8086 57.505V51.9736"
                                    stroke="#F58633"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ></path>
                                  <path
                                    d="M49.4072 57.6046V51.875"
                                    stroke="#F58633"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ></path>
                                  <path
                                    d="M55.0078 61.4791L55 48"
                                    stroke="#F58633"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ></path>
                                  ...
                                  ></path>
                                  <path
                                    d="M67.9219 58.7063V50.7734"
                                    stroke="#E5E7EB"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ></path>
                                  <path
                                    d="M87.001 40.0615C81.5648 40.0615 77.0615 44.2278 77.0615 49.4824V59.5176C77.0615 64.7722 81.5648 68.9385 87.001 68.9385H145.999C151.435 68.9385 155.938 64.7722 155.938 59.5176V49.4824C155.938 44.2278 151.435 40.0615 145.999 40.0615H87.001Z"
                                    stroke="url(#paint2_linear_218_14)"
                                    strokeWidth="1.87738"
                                  ></path>
                                  <path
                                    d="M87.0008 41H145.999C150.97 41 155 44.7976 155 49.4821V59.5179C155 64.2024 150.97 68 145.999 68H87.0008C82.0298 68 78 64.2024 78 59.5179V49.4821C78 44.7976 82.0298 41 87.0008 41Z"
                                    fill="url(#paint3_linear_218_14)"
                                  ></path>
                                  <path
                                    d="M106.191 57.505V51.9736"
                                    stroke="#F58633"
                                    strokeOpacity="0.1"
                                    strokeWidth="2.57594"
                                    strokeLinecap="round"
                                  ...
                                  <g filter="url(#filter0_d_218_14)">
                                    <path
                                      d="M62 29H64H66C67.1046 29 68 29.8954 68 31V33.7408C68 34.7475 67.4951 35.6871 66.6556 36.2426L66 36.6765L64.5519 37.6348C64.2173 37.8562 63.7827 37.8562 63.4481 37.6348L61.3444 36.2426C60.5049 35.6871 60 34.7475 60 33.7408V31C60 29.8954 60.8954 29 62 29Z"
                                      fill="black"
                                    ></path>
                                  </g>
                                  <path
                                    d="M65 33H63V75H65V33Z"
                                    fill="url(#paint4_linear_218_14)"
                                  ></path>
                                </g>
                                <g className="md:group-hover:scale-110 md:group-hover:rotate-12 origin-[60px_20px] transition-all duration-200 ease-in-out">
                                  <g className="md:group-hover:translate-x-1.5 md:group-hover:-translate-y-0.5 transition-all duration-200 ease-in-out">
                                    <path
                                      d="M20.6432 30.8138C18.5534 25.0291 21.5487 18.6455 27.3333 16.5557C33.118 14.4659 39.5016 17.4612 41.5914 23.2459C43.6812 29.0306 40.6859 35.4141 34.9012 37.5039C29.1165 39.5937 22.733 36.5985 20.6432 30.8138Z"
                                      className="fill-black dark:fill-[#ddd]"
                                    ></path>
                                    <path
                                      d="M29.9888 23.9055L29.9888 23.9055C28.2634 24.5289 27.3699 26.4329 27.9933 28.1584L27.9933 28.1584C28.6166 29.8839 30.5207 30.7773 32.2462 30.1539L32.2462 30.1539C33.9716 29.5306 34.8651 27.6265 34.2417 25.9011L34.2417 25.901C33.6184 24.1756 31.7143 23.2822 29.9888 23.9055Z"
                                      fill="#FE9641"
                                    ></path>
                                  </g>
                                  <path
                                    d="M27.5508 13.2773L9.8252 19.6806C7.39608 20.5582 6.13818 23.2388 7.01562 25.6679L13.4189 43.3935C14.2965 45.8226 16.9771 47.0805 19.4062 46.2031L37.1318 39.7998C38.2137 39.409 39.0629 38.6604 39.5947 37.7357"
                                    stroke="#F3F4F6"
                                    strokeWidth="2.5"
                                    strokeLinecap="round"
                                    className="md:group-hover:stroke-[#E5E7EB] transition-all duration-200 ease-in-out"
                                  ></path>
                                  <path
                                    d="M27.4364 14.6474L10.7894 20.6614C8.71166 21.412 7.63583 23.7048 8.38644 25.7825L14.4004 42.4295C15.151 44.5072 17.4439 45.5831 19.5216 44.8324L36.1685 38.8184C38.2463 38.0678 39.3221 35.775 38.5715 33.6973L32.5575 17.0503C31.8069 14.9726 29.5141 13.8968 27.4364 14.6474Z"
                                    fill="#FE9641"
                                  ></path>
                                  <path
                                    d="M27.4364 14.6474L10.7894 20.6614C8.71166 21.412 7.63583 23.7048 8.38644 25.7825L14.4004 42.4295C15.151 44.5072 17.4439 45.5831 19.5216 44.8324L36.1685 38.8184C38.2463 38.0678 39.3221 35.775 38.5715 33.6973L32.5575 17.0503C31.8069 14.9726 29.5141 13.8968 27.4364 14.6474Z"
                                    fill="url(#pattern1_218_14)"
                                    fillOpacity="0.5"
                                  ></path>
                                  <mask
                                    id="mask1_218_14"
                              ...
                              <defs>
                                ...
                                >
                                  ...
                                  <feBlend
                                    ...
                                    result="effect1_dropShadow_218_14"
                                  ></feBlend>
                                  <feBlend
                                    mode="normal"
                                    in="SourceGraphic"
                                    in2="effect1_dropShadow_218_14"
                                    result="shape"
                                  ></feBlend>
                                </filter>
                                <pattern
                                ...
                                >
                                  <image
                                    xlinkHref="/images/home/music.jpg"
                                    width="3840"
                                    height="2160"
                                    preserveAspectRatio="none"
                                    transform="translate(-0.36 0.35) scale(0.0003999) rotate(-19.5)"
                                  ></image>
                                </pattern>
                                <linearGradient
                                  id="paint0_linear_218_14"
                                  x1="72"
                                  y1="54.5"
                                  x2="-4.99999"
                                  y2="54.5"
                  ...
                  {/* Dubbed video */}
                  <a
                    data-agent-id="link-_r_8k_"
                    aria-label="Vídeo dublado"
                    className="group stack items-center outline-none"
                    data-testid="home-card-dubbing-studio"
                    href={`${basePath}/midias-visuais`}
                  >
                    <div className="stack gap-2 w-full max-w-[180px]">
                      <div className="relative overflow-hidden flex-1 rounded-[20px] flex items-center justify-center bg-black/5 dark:bg-white/5 group-hover:bg-black/10 dark:group-hover:bg-white/10 transition-colors duration-200 w-full outline-none group-focus-visible:outline-none group-focus-visible:ring-[1.5px] group-focus-visible:ring-ring">
                        <div className="relative w-full pb-[100%]"></div>
                        <div className="absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center [&_svg]:max-w-[90%]">
                          ...
                          >
                            ...
                            <defs>
                              ...
                              >
                                <image
                                  xlinkHref="/images/home/dubbing.png"
                                  width="401"
                                  height="305"
              ...
              <div
                className={
                  isAdmin
                    ? 'grid md:grid-cols-2 gap-10 mb-12'
                    : 'grid md:grid-cols-1 gap-10 mb-12'
                }
              >
                {/* Latest from the library */}
                <div>
                  <p className="text-lg text-fd-foreground font-semibold mb-3">
                    Últimos Podcasts
                  </p>
                  <ul className="eleven-list mb-2">
                    {episodes.length > 0 ? (
                      episodes.map((ep, idx) => {
                        const fallbackVoice =
                          podcastVoices[idx % podcastVoices.length];
                        const displayVoice = {
                          name: ep.title,
                          desc: ep.summary,
                        ...
                        const isCurrent =
                          currentVoice?.name === displayVoice.name;
                        const active = isCurrent && isPlaying;

                        const handlePlay = (e: React.MouseEvent) => {
                          e.stopPropagation();
                          if (!ep.audioUrl) {
                            toast.error('Este episódio ainda não possui um arquivo de áudio carregado ou baixado.');
                            return;
                          }
                          playTrack({
                            ...displayVoice,
                        ...
                        return (
                          <li
                            key={ep.id || idx}
                            onClick={handlePlay}
                            className="eleven-list-item hstack items-center px-3 gap-3 transition-colors duration-75 relative hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer group rounded-xl"
                          >
                            <div className="w-full hstack items-center py-3 gap-2">
                              <div className="shrink-0 center rounded-[10px] bg-transparent w-8 h-8 self-start my-1 focus-within:ring-0">
                                <div className="relative group shrink-0 h-8 w-8">
                                  <div className="block opacity-100 transition-opacity duration-100 h-full w-full">
                                    <div className="relative w-full h-full rounded-full overflow-hidden bg-[#FFFFFF] dark:bg-fd-background">
                                      ...
                                      <img
                                        ...
                                        style={{
                                          filter: `hue-rotate(${displayVoice.hue}deg) saturate(120%)`,
                                          transform: `rotate(${displayVoice.hue}deg)`,
                                  ...
                                  <div
                                    className={cn(
                                      'absolute inset-0 md:group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-100 z-10',
                                    ...
                                    >
                                      <div className="absolute inset-0 center">
                                        {active ? (
                                          ...
                                          >
                                            <path
                                              d="M8.38399 3.68914C7.05155 2.86616 5.33301 3.82463 5.33301 5.39074V14.6094C5.33301 16.1755 7.05155 17.134 8.38399 16.311L15.8467 11.7016C17.1121 10.9201 17.1121 9.07998 15.8467 8.29846L8.38399 3.68914Z"
                                              fill="currentColor"
                                            ></path>
                                          </svg>
                                        )}
                              ...
                              <div className="relative flex-1 min-w-0">
                                <p className="text-sm text-fd-foreground font-semibold line-clamp-1">
                                  {displayVoice.name}
                                </p>
                                <p className="text-sm text-fd-muted-foreground font-normal line-clamp-1">
                                  {displayVoice.desc}
                                </p>
                              </div>
                              <div className="relative hstack items-center w-fit hidden group-hover:flex gap-2">
                                <button className="relative inline-flex items-center justify-center whitespace-nowrap font-medium transition-colors duration-75 bg-[#FFFFFF] dark:bg-fd-background border border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 text-fd-foreground h-8 px-2.5 rounded-lg text-xs">
                                  Ouvir demo
                                </button>
                              </div>
                            </div>
                      ...
                      <li className="text-center p-3 text-sm text-gray-500">
                    ...
                    <div className="stack gap-2">
                      ...
                      <div className="h-full @container group">
                        <div className="hstack gap-4 h-full w-full -mx-1.5 p-1.5 relative items-center rounded-[16px] bg-[#FFFFFF] dark:bg-fd-background transition duration-200 min-h-[92px]">
                          ...
                          <div className="text-left shrink">
                            ...
                            <p className="text-sm font-normal mt-0.5 text-fd-muted-foreground">
                              Cadastre título, descrição, categoria, capa e
                              arquivo de áudio
                            </p>
                          </div>
                          <a
                            data-agent-id="link-_r_8d_"
                            aria-label="Voice Design"
                            className="absolute top-0 right-0 bottom-0 left-0 outline-none rounded-[24px] focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring"
                            data-testid="home-voice-design-card"
                            href={`${basePath}/episodios`}
                          ></a>
                        </div>
                      </div>
                      ...
                      <div className="hstack gap-4 h-full w-full -mx-1.5 p-1.5 relative items-center rounded-[16px] bg-[#FFFFFF] dark:bg-fd-background transition duration-200 group">
                              ...
                              <g className="md:group-hover:scale-[1.15] md:group-hover:translate-x-0.5 origin-center transition-all duration-200 ease-in-out">
                                ...
                                <g clipPath="url(#clip1_100_4687)">
                                  <rect
                                    width="16"
                                    height="16"
                                    transform="translate(45.1309 13.798) rotate(15)"
                                    fill="#2DD28D"
                                  ></rect>
                                  <path
                                    d="M49.211 28.4674C48.4117 28.4708 47.6223 28.2894 46.9046 27.9374C46.1869 27.5854 45.5603 27.0722 45.0737 26.4381C44.587 25.8039 44.2535 25.0658 44.0992 24.2814C43.9449 23.4971 43.974 22.6877 44.1842 21.9164C44.3944 21.1452 44.7799 20.4329 45.3108 19.8353C45.8417 19.2377 46.5035 18.7708 47.2446 18.4712C47.9857 18.1716 48.7861 18.0473 49.5831 18.108C50.3802 18.1688 51.1524 18.4129 51.8396 18.8214"
                                    stroke="white"
                                    strokeWidth="1.25"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                        ...
                        <div className="text-left shrink">
                          ...
                          <p className="text-sm font-normal mt-0.5 text-gray-500 dark:text-gray-400">
                            Atualize informações, convidados, capa e status de
                            publicação
                          </p>
                        </div>
                        <a
                          className="absolute top-0 right-0 bottom-0 left-0 outline-none rounded-[24px]"
                          href={`${basePath}/episodios`}
                        ></a>
                      </div>
                      ...
                      <div className="h-full @container group">
                        <div className="hstack gap-4 h-full w-full -mx-1.5 p-1.5 relative items-center rounded-[16px] bg-[#FFFFFF] dark:bg-fd-background transition duration-200 min-h-[92px]">
                              ...
                              >
                                <g className="md:group-hover:scale-[1.15] md:group-hover:-translate-x-0.5 origin-center transition-all duration-200 ease-in-out">
                                  <rect
                                    ...
                                    height="32"
                                    rx="10"
                                    transform="rotate(-15 7 12.2822)"
                                    fill="url(#pattern0_100_4678)"
                                    className="dark:hue-rotate-180 dark:invert"
                                  ></rect>
                                  <rect
                                    x="7"
                                    ...
                                    rx="10"
                                    transform="rotate(-15 7 12.2822)"
                                    fill="url(#paint0_linear_100_4678)"
                                    fillOpacity="0.8"
                                  ></rect>
                                  <rect
                                    x="7"
                                ...
                                <g className="md:group-hover:scale-[1.15] md:group-hover:translate-x-0.5 origin-center transition-all duration-200 ease-in-out">
                                  <rect
                                    ...
                                    height="32"
                                    rx="10"
                                    transform="rotate(15 39.4741 4.42325)"
                                    fill="#5D79DF"
                                    stroke="#F3F4F6"
                                    strokeWidth="2.5"
                                    className="md:group-hover:stroke-[#E5E7EB] transition-all duration-200 ease-in-out"
                                ...
                                <defs>
                                  <pattern
                                    id="pattern0_100_4678"
                                    patternContentUnits="objectBoundingBox"
                                    width="1"
                                    height="1"
                                  >
                                    <use
                                      xlinkHref="#image0_100_4678"
                                      transform="translate(-0.39153) scale(0.00148588)"
                                    ></use>
                                  </pattern>
                                  <linearGradient
                                    id="paint0_linear_100_4678"
                                    x1="23"
                                    y1="12.2822"
                                    x2="23"
                                    y2="44.2822"
                                  ...
                                  <clipPath id="clip0_100_4678">
                                    <rect
                                      ...
                                      height="16"
                                      fill="white"
                                      transform="translate(45.1309 14.2212) rotate(15)"
                                    ></rect>
                                  </clipPath>
                                  <image
                                    id="image0_100_4678"
                                    width="1200"
                                    height="673"
                                    xlinkHref="/images/home/voice-collections.png"
                                  ></image>
                                </defs>
                              </svg>
                            </div>
                          ...
                          <div className="text-left shrink">
                            ...
                            <p className="text-sm font-normal mt-0.5 text-fd-muted-foreground">
                              Remova episódios de teste, duplicados ou conteúdos
                              que não serão publicados
                            </p>
                          </div>
                          <a
                            data-agent-id="link-_r_8f_"
                            aria-label="Voice Collections"
                            className="absolute top-0 right-0 bottom-0 left-0 outline-none rounded-[24px] focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring"
                            data-testid="home-instant-voice-cloning-card"
                            href={`${basePath}/episodios`}
                          ></a>
                        </div>
                      </div>
