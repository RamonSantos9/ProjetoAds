...
import { TemplatesIcon } from '@/app/(home)/_components/podcast-dashboard/PodcastSidebar';
import {
  Search,
  Plus,
  Copy,
...
export default function ModelosPostAdminPage() {
  ...
  const templates: PostTemplate[] = [
    {
      id: 't1',
      name: 'Citação do Convidado',
      platform: 'Instagram',
      type: 'Feed',
      preview: 'https://picsum.photos/seed/t1/400/400',
      favorite: true,
    },
    {
      id: 't2',
      name: 'Alerta de Episódio Novo',
      platform: 'Instagram',
      type: 'Story',
      preview: 'https://picsum.photos/seed/t2/400/711',
    },
    {
      id: 't3',
      name: 'Destaque YouTube Thumb',
      platform: 'YouTube',
      type: 'Feed',
      preview: 'https://picsum.photos/seed/t3/400/225',
      favorite: true,
    },
    {
      id: 't4',
      name: 'Corte Rápido (Snippet)',
      platform: 'TikTok',
      type: 'Shorts',
      preview: 'https://picsum.photos/seed/t4/400/711',
    },
    {
      id: 't5',
      ...
      platform: 'Instagram',
      type: 'Feed',
      preview: 'https://picsum.photos/seed/t5/400/400',
    },
    {
      id: 't6',
      ...
      platform: 'Instagram',
      type: 'Story',
      preview: 'https://picsum.photos/seed/t6/400/711',
    },
  ];
          ...
          <section className="flex flex-col gap-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <p className="text-[#74748D] dark:text-fd-muted-foreground text-sm max-w-2xl">
                Acelere sua criação de conteúdo com templates pré-configurados.
                Basta selecionar um modelo e vincular o episódio desejado para
