                ...
                <span className="hstack gap-2 items-center max-w-full">
                  <div className="relative w-4 h-4 rounded-full overflow-hidden bg-[#FFFFFF] dark:bg-fd-background shrink-0">
                    <img
                      ...
                      style={{
                        filter: `hue-rotate(${currentVoice.hue}deg) saturate(120%)`,
                        transform: `rotate(${currentVoice.hue}deg)`,
                      }}
                ...
                <div className="hstack justify-between items-center gap-0.5 px-2">
                  ...
                  <div className="hstack items-center gap-2 max-md:hidden">
                    <button
                      ...
                      data-testid="audio-player-rewind-button"
                      className="relative center justify-center whitespace-nowrap text-sm font-medium transition-colors duration-75 focus-ring disabled:pointer-events-auto bg-transparent text-foreground hover:bg-black/5 dark:hover:bg-white/5 active:bg-black/10 dark:active:bg-white/10 disabled:bg-transparent disabled:text-gray-400 w-9 h-9 p-0 hidden md:flex rounded-full"
                    >
                      <svg
                        height="1.1rem"
                      ...
                      >
                        {isPlaying ? (
                          ...
                          <svg
                            ...
                            fill="currentColor"
                            aria-hidden="true"
                            className="shrink-0 w-5 h-5 translate-x-[5%]"
                          >
                            <path
                              fillRule="evenodd"
                    ...
                    <button
                      ...
                      data-testid="audio-player-fast-forward-button"
                      className="relative items-center justify-center whitespace-nowrap text-sm font-medium transition-colors duration-75 focus-ring disabled:pointer-events-auto bg-transparent text-foreground hover:bg-black/5 dark:hover:bg-white/5 active:bg-black/10 dark:active:bg-white/10 disabled:bg-transparent disabled:text-gray-400 center w-9 h-9 p-0 hidden md:flex rounded-full"
                    >
                      <svg
                        height="1.1rem"
                        className="shrink-0 w-5 h-5"
