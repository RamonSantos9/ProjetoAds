...
export function PodcastHeader() {
  ...
  const usagePercentage = Math.round(
    (1 - remainingCredits / totalCredits) * 100,
  );
    ...
    >
      <div className="relative">
        ...
        <div className="flex relative" style={{ opacity: 1 }}>
          <div
            className="absolute opacity-100 transition-opacity duration-300 [transform:rotate(18deg)] css-zrlz9h"
            aria-valuemax={100}
            aria-valuemin={0}
            aria-valuenow={9}
            role="progressbar"
          ...
          <div
            className="!absolute left-0 top-0 opacity-100 transition-opacity duration-300 [transform:rotateY(180deg)] css-zrlz9h"
            aria-valuemax={100}
            aria-valuemin={0}
            aria-valuenow={81}
            role="progressbar"
  ...
  return (
    <>
      ...
      <header
        ...
        style={{
          width: `calc(100% - ${collapsed ? '64px' : 'var(--podcastads-sidebar-width)'})`,
        }}
      >
          ...
          <div className="hstack items-center max-h-full w-fit gap-2 empty:hidden">
            ...
            >
              <button
                ...
                className="group w-full relative group items-center gap-0.5 h-10 w-10 justify-between flex rounded-lg text-sm leading-6 font-semibold outline-foreground transition-all duration-150"
              >
                {userButtonContent}
              </button>
            </PodcastUserMenu>
        ...
        <div className="w-full hstack px-2.5 border-b">
          ...
          <div className="shrink-0 hstack items-center gap-1">
            ...
            >
              <button
                aria-label="Seu perfil"
                className="relative shrink-0 rounded-full focus-ring transition-all duration-150"
              >
                {userButtonContent}
              </button>
            </PodcastUserMenu>
