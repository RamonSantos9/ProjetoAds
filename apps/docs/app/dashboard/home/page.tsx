                    ...
                    {episodes.length > 0 ? (
                      episodes.map((ep, idx) => {
                        ...
                        return (
                          <li
                            key={ep.id || idx}
                            className="eleven-list-item hstack items-center p-3 gap-3 transition-colors duration-75 relative hover:bg-black dark:hover:bg-white cursor-pointer group !p-0 !bg-transparent"
                          >
