  ...
  const podcastVoices = [
    {
      ...
      desc: 'Vinheta de abertura para apresentar o podcast, o curso de ADS e o objetivo do projeto academico.',
      img: 'orb-5.png',
      hue: 91,
      professional: true,
    },
    {
      ...
      desc: 'Locucao para conduzir a introducao do episodio, apresentar o tema e conectar os blocos da conversa.',
      img: 'orb-1.png',
      hue: 0,
      professional: true,
    },
    {
      ...
      desc: 'Demo de interacao para episodios com professores, empreendedores, desenvolvedores e convidados externos.',
      img: 'orb-5.png',
      hue: 164,
      professional: true,
    },
    {
      name: 'Encerramento do episodio',
      desc: 'Mensagem final com agradecimento ao publico, chamada para redes sociais e divulgacao do proximo episodio.',
      img: 'orb-4.png',
      hue: 332,
      professional: true,
    },
    {
      name: 'Chamada para divulgacao',
      desc: 'Trecho curto para reels, stories e posts de divulgacao do podcast academico nas redes sociais.',
      img: 'orb-5.png',
      hue: 339,
      professional: true,
    },
