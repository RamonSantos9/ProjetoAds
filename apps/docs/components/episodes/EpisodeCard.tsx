...
export function EpisodeCard({ episode, href, onEdit, isAdmin, className }: EpisodeCardProps) {
  return (
    <div className={cn("h-full", className)}>
      ...
      >
        <Link href={href} className="flex flex-col flex-1 p-[10px] gap-2 min-h-0">
          {/* Image / Placeholder */}
          ...
          <div className="flex flex-col w-full gap-1 flex-1">
            ...
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mt-1">
               <span className="text-[11px] text-[#6F6F88] dark:text-[#8A8AA3] font-bold">Criado por:</span>
...
export function EpisodeListItem({ episode, href, onEdit, isAdmin }: EpisodeCardProps) {
  return (
